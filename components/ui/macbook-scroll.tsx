...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:mt-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      {
        title && <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#010101] rounded-2xl p-2 mt-4"
      >
